...
def parse_args():
    parser = argparse.ArgumentParser(description="Argument parser for MF Tuning script")
...
def objective(trial):
    ...
    # variables: id_embed_dim ; learning_rate ; weight_decay ; warmup_ratio ; 
...
if __name__ == "__main__":
    ...
    num_batches_train = args.num_batches_train  #  for yelp ;  for clothing  ;  for toys ; 961 for beauty (10% of train data)
    num_batches_val = args.num_batches_val #  for yelp ;  for clothing ;  for toys ; 1398 for beauty  (full val data)
