...
def evaluate_collm(seed=999,
    ...
    print("Arguments passed to evaluate_collm():")
    for arg in x:
    ...
    batch_size = 100
    eval_loader, eval_dataset = get_dataset_loader(dataset=dataset, data_path=data_path, batch_size=batch_size, workers=num_workers, shuffle = False, distributed=False,local_rank=gpu)    
...
if __name__ == "__main__":
    ...
    evaluate_results = evaluate_collm(seed=args.seed,
                   gpu = args.gpu,
