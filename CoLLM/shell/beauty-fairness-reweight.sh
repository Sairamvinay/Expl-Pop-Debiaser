# CoLLM + FairIPS training script
# Stage 1 Training can be done by independently training TALLRec 1st 
# We can re-use TALLRec checkpoints as Stage 1 points
...
seed=999
output_dir="snap/llama-beauty-IPS/" # replace with yelp here
data_path="../data/"
