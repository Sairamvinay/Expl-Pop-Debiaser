...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default="generated-expl/", help='Directory to save generated explanations')
...
def main(args):
    ...
    if args.log_wandb:
        wandb.init(project='explanation-generation',config=vars(args),reinit=True)
    ...
    if os.path.exists(save_path):
        ...
        print("Loaded Explanations: ",len(explanations))
    else:
        explanations = {}
