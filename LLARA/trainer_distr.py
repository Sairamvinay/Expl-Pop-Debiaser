...
def train_custom(args):
    ...
    train_dataset = get_dataset_object(sample_numbers = train_sample_number, mode='train', dataset=args.dataset, data_path=args.data_path, local_rank = args.local_rank)
