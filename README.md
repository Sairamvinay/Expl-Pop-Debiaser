...
4) Create negative items for BPR training for our method using `notebook-data-creation/beauty-negativeBPRCandidates.ipynb` and related notebooks for other datasets.  Place it inside `data/$DATASET$` directory.
...
## Baselines
Please follow `TALLRec` (Credits: [here](https://github.com/SAI990323/TALLRec)) and `CoLLM` (Credits: [here](https://github.com/zyang1580/CoLLM)) for further code.
