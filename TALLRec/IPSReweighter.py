...
class IPS(object):
    ...
    def calculate_weights(self):
        ...
        for index in range(len(self.dataset)):
            ...
            history_items = sample['history_item']
            for item in history_items:
                pop_idx = self.dataset.iid2pid_dict[item]
                history_count[pop_idx] += 1
            
            pop_idx_target = self.dataset.iid2pid_dict[sample['target_item']]
    ...
    def reweight(self, input_dict):
        ...
        '''
        return [self.weight_map[self.dataset.iid2pid_dict[item]] for item in input_dict['target_items']]
